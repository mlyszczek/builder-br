...
rootfs_path=/var/diskless/images/q${arch}lin
...
echo -e "\tsudo cp output/images/zImage ${kernel_path}/q${arch}lin-${kernel_version}"
...
sudo cp output/images/bzImage ${kernel_path}/q${arch}lin-${kernel_version}
sudo chown qemu:qemu ${kernel_path}/q${arch}lin-${kernel_version}
